...
const Page = () => {
  ...
  return (
    <>
      <div className="h-screen flex md:mt-[70rem] xsm:mt-[60rem] lg:mt-[35rem] mt-[35rem] flex-col relative">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center pt-8 z-20">
              ...
              <div
                ...
                className="text-transparent bg-Green-gradient bg-clip-text text-[3rem] sm:text-[4rem] md:text-[6rem] lg:text-[10em] xl:text-[12rem] 2xl:text-[14rem] font-extrabold font-akira leading-none tracking-[0.5rem] sm:tracking-[1.2rem] md:tracking-[1.7rem] customBreakpoint:mt-[32rem] sm:mt-[30rem] md:mt-[20rem]"
              >
                <div className="overflow-hidden glow1 xsm:w-[20rem] xsm:top-[40rem] md:w-[40rem] md:top-[33rem] lg:top-[26rem] lg:w-[60rem] top-[26rem] w-[60rem] h-[65rem] z-10 ">
          ...
          <div className=" mt-[2rem] 2xl:mt-[11rem] flex flex-col items-center  sm:flex ">
              <motion.img
