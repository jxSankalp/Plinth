...
import "./page.css";
import { Glow, arrow1, arrow2 } from "../assets/svg";

// Throttle function to limit the number of times the mouse move event triggers
...
const Page = () => {
  ...
  // Mouse movement handler for rotating the text
  ...
  useEffect(() => {
    const xxvTimeout = setTimeout(() => setShowXXV(true), 5700);
    const comingSoonTimeout = setTimeout(() => setShowComingSoon(true), 6200);
    ...
    <div className="h-screen flex md:mt-[70rem] lg:mt-[35rem] mt-[35rem] flex-col relative">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center pt-8 z-20">
        ...
        <motion.div
          ...
          animate={showComingSoon ? { opacity: 1, filter: "blur(0px)" } : {}}
